      ...
      <main className="main-content">
        <div className={`container ${styles.pageHeader}`}>
          ...
          <p className={styles.subtitle}>
            Discover 16+ verified AI-appraised global real estate assets on BOT Chain.
          </p>
        </div>
        ...
        <div className={`container ${styles.grid}`}>
          {filteredProperties.length > 0 ? (
            ...
            <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '3rem 0', color: 'var(--color-text-secondary)' }}>
              <h3>No properties matching this filter criteria</h3>
              <p style={{ marginTop: '0.5rem' }}>Try clearing filters to see all 16 available properties.</p>
            </div>
          )}
        </div>
      </main>
